...
def GlobalIDWInterpolation(which_discrete_points,grid_length,show=False):
...
def ScattersInGridIDW(which_discrete_points,grid_length,show=False):
...
#            print(this_pos)
    ...
    #comfortable
    z_mesh_points=cp.deepcopy(img_tag)
