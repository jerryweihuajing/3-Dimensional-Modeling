...
#            print(type(des_x_acc),type(des_y_acc),type(des_z_acc))
...
#            print(type(roll_torque),type(pitch_torque),type(yaw_torque))
            
            roll_vel += roll_torque * dt / Ixx
            pitch_vel += pitch_torque * dt / Iyy
            yaw_vel += yaw_torque * dt / Izz
            
#            print(type(roll_vel),type(pitch_vel),type(yaw_vel))
...
#            print(type(roll), type(pitch), type(yaw))
            
            R = rotation_matrix(roll, pitch, yaw)
            
#            print(R)
#            print(np.array([0, 0, thrust]).T)
            
            if len(list(thrust))==1:
